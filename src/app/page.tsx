    ...
    <main className="flex min-h-screen flex-col items-center justify-center text-white">
      <div className="container flex max-w-[70rem] flex-col items-center justify-center gap-12 px-4 py-16">
        ...
        <p className="text-center text-2xl">
          This is a NextJS project for MinionAH. It is used to build stuff
          MinionAH needs that can't be done with Svelte/SvelteKit because a
          package isn't available or the ecosystem isn't mature enough.
          <br /><br />
